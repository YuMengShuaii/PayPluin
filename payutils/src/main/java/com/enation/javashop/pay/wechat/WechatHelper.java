package com.enation.javashop.pay.wechat;
...
import com.enation.javashop.pay.config.PayConfig;
import com.enation.javashop.pay.utils.CurrencyUtils;
import com.enation.javashop.pay.utils.DesUtils;
import com.enation.javashop.pay.utils.MD5;
...
import com.enation.javashop.pay.utils.Util;
...
public class WechatHelper {
    ...
    private String createProductArgs() {
        ...
        try {
            ...
            packageParams.add(new BasicNameValuePair("notify_url", PayConfig.getPayUrl() /*+ "/api/shop/b_wechatMobilePlugin_payment-callback/execute.do"*/));
