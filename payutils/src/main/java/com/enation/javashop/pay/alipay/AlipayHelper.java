package com.enation.javashop.pay.alipay;
...
//        orderInfo += "&total_fee=" + "\"0.01\"";
        ...
        // 服务器异步通知页面路径
        orderInfo += "&notify_url=" + "\"" + PayConfig.getPayUrl() /*+ "/api/shop/b_alipayMobilePlugin_payment-callback/execute.do"*/
                + "\"";
